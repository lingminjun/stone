...
import com.lmj.stone.lang.I18N;
 ...
 * 远程服务异常申明
 */
public class IDLException extends Exception implements Serializable {
    ...
    public IDLException(String message, String domain, int code, Throwable cause) {
        super(message, cause);
        this.msg = message;
    ...
    public IDLException(String message, String domain, int code, String reason) {
        super(message);
        this.msg = message;
        this.l10n = I18N.l10n(message);
        this.code = code;
    ...
    public IDLException setCoreCause(Throwable inner) {
        this.inner = inner;
